...
np.savetxt("accuracy_credit_card_Raw_Data.csv", acc, delimiter=',')
...
ax.legend(loc=2)
fig.savefig('AccForAllClassification_credit_card_Raw_Data.png')
...
ax1.legend(loc=2)
fig1.savefig('TimeTakenForAllClassification_credit_card_Raw_Data.png')
...
ax1.legend(loc=2)
fig1.savefig('F_Score_ForAllClassification_credit_card_Raw_Data.png')