...
y=np.genfromtxt('Letter_Recognition.csv', delimiter = ',',dtype = 'str',usecols=(0))
...
np.savetxt("accuracy_Letter_Recognition_FeatureSelected.csv", acc, delimiter=',')
...
ax.legend(loc=2)
fig.savefig('AccForAllClassification_Letter_Recognition_FeatureSelected.png')
...
ax1.legend(loc=2)
fig1.savefig('TimeTakenForAllClassification_Letter_Recognition_FeatureSelected.png')
...
ax1.legend(loc=2)
fig1.savefig('F_Score_ForAllClassification_Letter_Recognition_FeatureSelected.png')